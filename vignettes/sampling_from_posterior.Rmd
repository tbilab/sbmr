...
sweep_results <- mcmc_sweep(my_sbm, num_sweeps = num_sweeps, track_pairs = TRUE)
...
sweep_df_lower_eps <- mcmc_sweep(my_sbm, num_sweeps = num_sweeps)$sweep_info %>% 
  mutate(sweep = 1:n(),
